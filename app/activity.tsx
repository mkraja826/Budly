  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <View style={styles.content}>
        <Text accessibilityElementsHidden style={styles.character}>
          🧒
        </Text>
        ...
        <View style={styles.progressDots}>
          {APPLES.map((apple) => (
            <View key={apple} style={[styles.dot, selected.includes(apple) && styles.dotDone]} />
          ))}
        </View>
        ...
        {complete ? (
          <View style={styles.celebration}>
            ...
            <Pressable
              accessibilityLabel="Collect your seed reward"
              accessibilityRole="button"
              onPress={() => router.replace('/garden?earned=seed')}
              style={styles.action}
            >
